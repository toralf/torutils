...
function __fill_trustlist() {
  (
    echo "2a0c:dd40:1:b::42 2a0c:dd40:1:b::43 2a0c:dd40:1:b::44 2a0c:dd40:1:b::45 2a0c:dd40:1:b::46"
    ...
    getent ahostsv6 snowflake-01.torproject.net. | awk '{ print $1 }' | sort -u
