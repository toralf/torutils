...
#
# slew a /22 and a /24 network segment, limit to 15/min:
#   EGRESS_SUBNET_SLEW="1.2.3.4/22 5.6.7.8/24" /opt/torutils/ipv4-rules-egress.sh start 15
...
if [[ ${1-} == "start" ]]; then
  ...
  # set our limit/minute to 2/3 of it
  limit=${2:-$((150 * 2 / 3 / 4))}
