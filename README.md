...
*info.py* gives an overview about all current connections of a relay:
...
*ps.py* monitors exit ports usage:
...
*orstatus.py* logs events of type *CLOSED*:
...
*key-expires.py* helps to not pass the date to renew an offline key, ie.:
